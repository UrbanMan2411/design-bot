...
# === Themed images (8+ per theme, verified Unsplash IDs) ===
THEME_IMAGES = {
    ...
    "restaurant|ресторан|еда|food|кухня|меню|пицц|бургер|суши": [
        ...
        "1476224203421-9ac39bcb3327", "1567620905732-2d1ec7ab7445",
    ],
...
def get_theme_images(prompt: str, count: int = 5) -> list[str]:
    ...
    for i, pid in enumerate(selected):
        ...
        urls.append(f"https://images.unsplash.com/photo-{pid}?w={w}&h={h}&fit=crop&q=80")
    return urls
